...
100.times do 
  doctors = Doctor.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, zip_code: Faker::Address.zip, specialty: specialties.sample, city: cities.sample)
end
doctors = Doctor.all
